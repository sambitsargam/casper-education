...
const STORE = [
    {
        number: 1,
        question: "The Casper VM executes a smart contract by calling the which Function?",
        options: [
            "Call function",
            "Main function",
            "None of the Above",
        ...
        explanation: "The Casper VM executes a smart contract by calling the call function specified in the contract. If the function is missing, the smart contract is not valid.",
    },
    {
        number: 2,
        question: "What happened when shrinking the WASM file size as much as possible?",
        options: [
            "Smaller deploys cost less",
            "Save the network bandwidth",
            "Save Time",
            "All of the above",
        ],
        answer: "All of the above",
        explanation: "We encourage shrinking the WASM file size as much as possible. Smaller deploys cost less and save the network bandwidth.",
    },
    {   
        number: 3,
